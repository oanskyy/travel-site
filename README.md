...
- Use the Netlify service to not only host the website but also use basic cloud (or AWS Lambda) functions. [![Netlify Status](https://api.netlify.com/api/v1/badges/2e007a05-4425-44ee-9634-2f96a4c15ac6/deploy-status)]
